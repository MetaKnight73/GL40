...
FenetreOptions::FenetreOptions(QWidget *parent) : QDialog(parent) {
...
void FenetreOptions::restoreDefaultValues() {
...
void FenetreOptions::restoreExpertValues() {
...
int FenetreOptions::getNbClics() {

    return spinNbClics->value();

}

double FenetreOptions::getParametre1() {

    return spinParam1->value();

}

double FenetreOptions::getParametre2() {
